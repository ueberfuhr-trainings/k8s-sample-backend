...
The database must be initialized with the following schema before starting the application
(since the production profile uses `validate` as schema management strategy):
